          ...
          <div className="px-4 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
            {categories.map((category) => (
              <div key={category}>
                <button
                  onClick={() => handleCategoryClick(category)}
                  className="w-full text-left py-3 text-base font-medium text-gray-700 hover:text-black transition-colors uppercase tracking-wide focus:outline-none focus:ring-2 focus:ring-[#E6397E] min-h-10"
                  tabIndex={0}
                >
                  {category}
                </button>
                  ...
                  <div className="ml-4 mt-2 space-y-1">
                    {subcategories[category as keyof typeof subcategories].map((subcategory) => (
                      <button
                        key={subcategory}
                        onClick={() => handleSubcategoryClick(category, subcategory)}
                        className="w-full text-left py-3 px-3 text-base text-gray-600 hover:bg-gray-50 hover:text-black transition-colors rounded-md focus:outline-none focus:ring-2 focus:ring-[#E6397E] min-h-10"
                        tabIndex={0}
                      >
                        {subcategory}
                      </button>
